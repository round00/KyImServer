...
bool Zlib::compressBuf(const char* pSrcBuf, size_t nSrcBufLength, char* pDestBuf, size_t & nDestBufLength)
{
...
bool Zlib::compressBuf(const std::string& strSrcBuf, std::string& strDestBuf)
{
    if (strSrcBuf.empty())
        return false;
...
bool Zlib::uncompressBuf(const std::string& strSrcBuf, std::string& strDestBuf, size_t nDestBufLength)
{
    char* pDestBuf = new char[nDestBufLength];
    memset(pDestBuf, 0, nDestBufLength * sizeof(char));
...
bool Zlib::deflate(const std::string& strSrc, std::string& strDest)
{
...
bool Zlib::inflate(const std::string& strSrc, std::string& strDest)
{
    int err = Z_DATA_ERROR;
    // Create stream
    z_stream zS = { 0 };
